    ...
    async def build_assimilator(self):
        for nexus in self.units(UnitTypeId.NEXUS).ready:
            ...
            for vaspene in vaspenes:
                ...
                if worker is None:
                    break
                if not self.units(UnitTypeId.ASSIMILATOR).closer_than(1.0, vaspene).exists and not self.already_pending(UnitTypeId.ASSIMILATOR):
